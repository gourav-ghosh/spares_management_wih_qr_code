...
>
    <div class="main_container">
        ...
        <div
            ...
            "
        >
            <u> ID: {{$tool_detail->tool_id}} </u>
        </div>
        @if(count($tool_detail->medias)>0)
        <div
            style="
                display: flex;
        ...
        >
            <img
                src="{{$tool_detail->medias[0]->path}}"
                alt=""
                srcset=""
                width="100%"
                height="100%"
                class="gallery-item"
                val="{{$tool_detail->medias[0]->path}}"
                media_type="image"
            />
        </div>
        @endif
        ...
        <div class="accordion-item" style="margin: 10px 0px">
            <h2 class="accordion-header" id="flush-headingOne">
                ...
                >
                    ...
                    @if(count($tool_detail->medias) !== 0)
                    @foreach($tool_detail->medias as $media)
        ...
        >
            ...
            @if(Auth::check())
            <a href="/update_tool/{{$tool_detail->id}}">
                <div
                    style="
                        padding: 0 8px;
                        height: 28px;
        ...
        <div
            ...
            "
        >
            <b>Name: </b> @if($tool_detail->tool_name)
            {{$tool_detail->tool_name}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
            ...
            "
        >
            <b>Machine: </b> @if($tool_detail->machine)
            {{$tool_detail->machine}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
        ...
        >
            <b>Safety Status: </b>
            @if($tool_detail->safety_status == 'safe') Safe @else Rejected
            @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Specification: </b> @if($tool_detail->specification)
            {{$tool_detail->specification}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
            ...
            "
        >
            <b>Last Inspection: </b> @if($tool_detail->last_inspection_date)
            {{Carbon\Carbon::parse($tool_detail->last_inspection_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Due Inspection: </b> @if($tool_detail->inspection_due_date)
            {{Carbon\Carbon::parse($tool_detail->inspection_due_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
