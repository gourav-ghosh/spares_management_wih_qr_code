            ...
            >
                ...
                <div>
                    <span id="customer_style"
                        >Tool Id<span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                ...
                <div>
                    <span id="customer_style"
                        >Machine<span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                ...
                <div>
                    <span id="customer_style"
                        >Location<span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                ...
                <input
                    ...
                    @if($tool)
                    value="{{$tool->last_inspection_date}}"
                    @endif
                />
                <br />
                ...
                <input
                    ...
                    type="date"
                    placeholder="Enter Due Inspection Date"
                    @if($tool)
                    value="{{$tool->inspection_due_date}}"
                    @endif
                />
                <br />
                ...
                <textarea
                    ...
                    style="
                        ...
                        width: 90%;
                    "
                    placeholder="Specification of tool."
                    required
                >
@if($tool) {{$tool->specification}} @endif</textarea
                >
