...
>
    ...
    <div class="scrollmenu">
        ...
        <a
            id="mechanical_maintenance"
            type="button"
            href="/dashboard/machines/mechanical_maintenance"
            name="answer"
            id="btn3"
            class="notifier new"
        >
    ...
    <div class="container text-center">
        ...
        @if(count($machines)>0) @foreach($machines as $machine)
                    ...
                    >
                        <div style="width: 45%">
                            <img
                                ...
                                src="{{$machine->medias[0]->thumbnail_path}}"
                        ...
                        <div style="word-wrap: normal; width: 48%">
                            <div style="word-wrap: break-word; margin: 5px 0px">
                                <span style="font-weight: 600; font-size: 18px">
                                    Id: @if($machine->machine_id){{$machine->machine_id}}
                                    @else Not Available @endif</span
                                >
                            </div>
                            <div style="word-wrap: break-word; margin: 5px 0px">
                                <span style="font-weight: 500; font-size: 16px">
                                    Name: @if($machine->machine_name){{$machine->machine_name}}
                                    @else Not Available @endif</span
                                >
                            </div>
                            <div style="word-wrap: break-word; margin: 5px 0px">
                                <span style="font-weight: 500; font-size: 16px">
                                    Department: @if($machine->department &&
                                    $machine->department == 'mcl') MCL
                                    @elseif($machine->department &&
                                    $machine->department == 'ccl') CCL
                                    @elseif($machine->department &&
                                    $machine->department ==
                            ...
                            <div style="word-wrap: break-word; margin: 5px 0px">
                                <span style="font-weight: 500; font-size: 16px">
                                    Type: @if($machine->machine_type){{$machine->machine_type}}
                                    @else Not Available @endif</span
                                >
                            </div>
                        </div>
...
<script>
    function rows_per_page() {
        ...
        window.location.href = `/dashboard/machines/{{$department}}?${parseResult}&rows_per_page=${per_page}`;
    }
</script>
