...
>
    <div class="main_container">
        ...
        >
            <img
                src="{{$machine_detail->medias[0]->path}}"
                alt=""
                srcset=""
                width="100%"
                height="100%"
                class="gallery-item"
                val="{{$machine_detail->medias[0]->path}}"
                media_type="image"
            />
        </div>
        @endif
        ...
        <div
            ...
            "
        >
            <b>Name: </b> @if($machine_detail->machine_name)
            {{$machine_detail->machine_name}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
            ...
            "
        >
            <b>Type: </b> @if($machine_detail->machine_type)
            {{$machine_detail->machine_type}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
        ...
        >
            <b>Department: </b>
            @if($machine_detail->department && $machine_detail->department ==
            'mcl') MCL @elseif($machine_detail->department &&
            $machine_detail->department == 'ccl') CCL
            @elseif($machine_detail->department && $machine_detail->department
            == 'mechanical_maintenance') Mechanical Maintenance @else N.A.
            @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Description: </b> @if($machine_detail->description)
            {{$machine_detail->description}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
        ...
        >
            ...
            @if($machine_detail->last_maintenance_date)
            {{Carbon\Carbon::parse($machine_detail->last_maintenance_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Due Maintenance: </b> @if($machine_detail->due_maintenance_date)
            {{Carbon\Carbon::parse($machine_detail->due_maintenance_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        <div
            style="
        ...
        >
            ...
            @if($machine_detail->operation_start_date)
            {{Carbon\Carbon::parse($machine_detail->operation_start_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        ...
        <div style="margin: 15px 5px">
            ...
            <a href="/spare/{{$spare->id}}">
                ...
                >
                    ...
                    >
                        <img
                            src="{{$spare->medias[0]->thumbnail_path}}"
                            alt="spare{{ $key + 1 }}"
                            srcset=""
                            width="100%"
                            height="100%"
