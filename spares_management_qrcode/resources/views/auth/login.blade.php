...
<div class="col py-3">
    @error('error')
    <div class=" popup-message" style="position: fixed;left: 50%;transform: translate(-50%, 0);z-index: 10;border-radius: 5px;width: 50%;margin-top: 2%;font-size: 30px;font-weight: bolder;text-align: center;padding: 5px;  color: #842029;
    ...
    <div class="popup-message"
        style="position: fixed;left: 50%;transform: translate(-50%, 0);z-index: 10;border-radius: 5px;width: 50%;margin-top: 2%;font-size: 30px;font-weight: bolder;color: #0F5132;background-color: #D1E7DD;border-color: #BADBCC;text-align: center;padding: 5px;">
        {{ session()->get('message') }}
    </div>
    @endif
</div>
    ...
    <form action="/login" method="POST" style="display:none;" id="myForm">
        ...
        <div class="row">
            <input type="number" name="phone" id="phone" autocomplete="off" placeholder="Enter your phone no."
                pattern="[0-9]{10}" onKeyPress="if(this.value.length == 10) return false;" required>
        </div>
        <div class="row">
        ...
        <div class="bottom_part">
            <div class="rememberMe">
                <input type="checkbox" name="remember_me" value="remember_me" id="rememberMe">
                <label for="rememberMe">Remember Me</label>
            </div>

            <div class="data">
                <div class="model">
                    <strong style="color:white;">Contact the Dispatch Manager to change your password.</strong>
                    <div class="btn">
                        <p class="wrap">Ok!</p>
                    </div>
...
body {
    ...
    margin: 0;
    padding: 0;
    background: url(./dist/assets/Group_43.png) no-repeat center center fixed;
