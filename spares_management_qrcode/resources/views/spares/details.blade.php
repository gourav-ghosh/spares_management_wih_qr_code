    ...
    <div class="main_container">
        ...
        <div style="margin-bottom: 15px; font-size: 20px; margin-left: 0px; display: flex; justify-content: space-between; gap: 10px; margin-right: 10px;">
            ...
            <div>
                ...
                <a href="/dashboard/spares" style="text-decoration: none; margin-right: 10px;">
        ...
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Type: </b> @if($spare_detail->spare_type) {{$spare_detail->spare_type}} @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Department: </b> 
            @if($spare_detail->department && $spare_detail->department == 'mcl') MCL 
            @elseif($spare_detail->department && $spare_detail->department == 'ccl') CCL
            @elseif($spare_detail->department && $spare_detail->department == 'mechanical_maintenance') Mechanical Maintenance
            @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Storage: </b> 
            @if($spare_detail->spare_storage && $spare_detail->spare_storage == 'roll_stand') Roll Stand 
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'workshop') Workshop Area
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'spm') SPM Area
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'os_mcl') Oil Storage MCL
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'os_ccl') Oil Storage CCL
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'mcl_exit') MCL Exit
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'jk_bay') JK Bay Area
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'de_bay') CCL DE Bay area
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage == 'cd_bay') MCL CD Bay area
            @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Description: </b> @if($spare_detail->description) {{$spare_detail->description}} @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Last Installation: </b> @if($spare_detail->last_installation_date) {{Carbon\Carbon::parse($spare_detail->last_installation_date)->format('d-m-y')}} @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Last Maintenance: </b> @if($spare_detail->last_maintenance_date) {{Carbon\Carbon::parse($spare_detail->last_maintenance_date)->format('d-m-y')}} @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Due Maintenance: </b> @if($spare_detail->due_maintenance_date) {{Carbon\Carbon::parse($spare_detail->due_maintenance_date)->format('d-m-y')}} @else N.A. @endif
        </div>
        <div style="font-size: 18px; letter-spacing: 2px; margin-left: 20px; word-spacing: 10px; margin-top: 5px;">
            <b>Operation Started: </b> @if($spare_detail->operation_start_date) {{Carbon\Carbon::parse($spare_detail->operation_start_date)->format('d-m-y')}} @else N.A. @endif
        </div>
            ...
            <a href="/machine/{{$parent_machine->id}}">
                <div style="display: flex; justify-content: left; gap: 0px 10px; margin: 10px 10px; border-radius: 5px; background-color: #ecebe9; padding: 10px; cursor: pointer;">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; width: 80px; aspect-ratio: 1/1; margin-left: 2%;">
                        <img src="{{$parent_machine->medias[0]->thumbnail_path}}" alt="spare{{$key+1}}" srcset="" width="100%" height="100%">
                    </div>
