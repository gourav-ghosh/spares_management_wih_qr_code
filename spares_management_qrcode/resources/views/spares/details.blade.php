...
>
    <div class="main_container">
        ...
        >
            <img
                src="{{$spare_detail->medias[0]->path}}"
                alt=""
                srcset=""
                width="100%"
                height="100%"
                class="gallery-item"
                val="{{$spare_detail->medias[0]->path}}"
                media_type="image"
            />
        </div>
        @endif
        ...
        <div class="accordion-item" style="margin: 10px 0px">
            <h2 class="accordion-header" id="flush-headingOne">
                ...
                >
                    ...
                    @if(count($spare_detail->medias) !== 0)
                    @foreach($spare_detail->medias as $media)
                    @if($media->for_status == "detail" && ($media->media_type ==
                    "image" || $media->media_type == "video"))
                    @php($details_image_count++) @endif @endforeach @endif
                    ...
                    <section class="gallery">
                        <div class="container-lg">
                            ...
                            >
                                ...
                                @endif @if($media->for_status == "detail" &&
        ...
        >
            <img
                src="\dist\assets\mcl_general_layout.png"
                alt=""
                srcset=""
                width="100%"
                height="100%"
                class="gallery-item"
                val="\dist\assets\mcl_general_layout.png"
                media_type="image"
            />
        </div>
        @endif
        ...
        <div
            ...
            "
        >
            <b>Name: </b> @if($spare_detail->spare_name)
            {{$spare_detail->spare_name}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
            ...
            "
        >
            <b>Type: </b> @if($spare_detail->spare_type)
            {{$spare_detail->spare_type}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
        ...
        >
            <b>Department: </b>
            @if($spare_detail->department && $spare_detail->department == 'mcl')
            MCL @elseif($spare_detail->department && $spare_detail->department
            == 'ccl') CCL @elseif($spare_detail->department &&
            $spare_detail->department == 'mechanical_maintenance') Mechanical
            Maintenance @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
        ...
        >
            <b>Storage: </b>
            @if($spare_detail->spare_storage && $spare_detail->spare_storage ==
            'roll_stand') Roll Stand @elseif($spare_detail->spare_storage &&
            $spare_detail->spare_storage == 'workshop') Workshop Area
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage
            == 'spm') SPM Area @elseif($spare_detail->spare_storage &&
            $spare_detail->spare_storage == 'os_mcl') Oil Storage MCL
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage
            == 'os_ccl') Oil Storage CCL @elseif($spare_detail->spare_storage &&
            $spare_detail->spare_storage == 'mcl_exit') MCL Exit
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage
            == 'jk_bay') JK Bay Area @elseif($spare_detail->spare_storage &&
            $spare_detail->spare_storage == 'de_bay') CCL DE Bay area
            @elseif($spare_detail->spare_storage && $spare_detail->spare_storage
            == 'cd_bay') MCL CD Bay area @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
            ...
            "
        >
            <b>Description: </b> @if($spare_detail->description)
            {{$spare_detail->description}} @else N.A. @endif
        </div>
        <div
            style="
                font-size: 18px;
            ...
            "
        >
            <b>Last Installation: </b>
            @if($spare_detail->last_installation_date)
            {{Carbon\Carbon::parse($spare_detail->last_installation_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Last Maintenance: </b> @if($spare_detail->last_maintenance_date)
            {{Carbon\Carbon::parse($spare_detail->last_maintenance_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Due Maintenance: </b> @if($spare_detail->due_maintenance_date)
            {{Carbon\Carbon::parse($spare_detail->due_maintenance_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>
        <div
            style="
            ...
            "
        >
            <b>Operation Started: </b> @if($spare_detail->operation_start_date)
            {{Carbon\Carbon::parse($spare_detail->operation_start_date)->format('d-m-y')}}
            @else N.A. @endif
        </div>

        @if(count($spare_detail->maintenances)>0)
        <div
            style="
                font-size: 24px;
                font-weight: 600;
        ...
        <table style="margin: 10px; width: calc(100% - 20px)">
            ...
            <tbody>
                @foreach($spare_detail->maintenances as $key => $maintenance)
                <tr>
                    <td
                        style="
                            padding: 15px;
                    ...
                    >
                        ...
                        {{Carbon\Carbon::parse($maintenance->maintenance_completed)->format('d-m-y')}}
        ...
        @endif @if(count($parent_machines)>0)
        <div
            style="
                font-size: 24px;
                font-weight: 600;
        ...
        <div style="margin: 15px 5px">
            @foreach($parent_machines as $key => $parent_machine)
            <a href="/machine/{{$parent_machine->id}}">
                <div
                    style="
                        display: flex;
                ...
                >
                    ...
                    >
                        <img
                            src="{{$parent_machine->medias[0]->thumbnail_path}}"
                            alt="spare{{ $key + 1 }}"
                            srcset=""
                            width="100%"
                            height="100%"
