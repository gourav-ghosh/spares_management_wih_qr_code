    ...
    <div style="padding-left: 30px;">
        ...
        <div>
            <form action="/add_spare" method="post" enctype="multipart/form-data">
                ...
                <div><span id="customer_style">Parent Machine<span
                    style="color: #F72C1D; padding-left: 1px;">*</span></span>
                </div>
                <select name="parent_machine" id="parent_machine1" class="machine_select" required>
                ...
                <div><span id="customer_style">Last Installation Date
                    <!-- <span style="color: #F72C1D; padding-left: 1px;">*</span> -->
                </span>
                </div>
