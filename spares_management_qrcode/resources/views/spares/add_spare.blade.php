            ...
            >
                ...
                <div>
                    <span id="customer_style"
                        >Spare Id<span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                ...
                <select
                    ...
                    required
                >
                    <option value="" disabled selected>Select Parent Machine                                 
                    </option>
                    @if($machines) @foreach($machines as $machine)
                    <option value="{{$machine->id}}" @if($spare && $spare->
                        parent_machine == $machine->id) selected @endif>{{$machine->machine_id}}
                    </option>
                    @endforeach
                ...
                <input
                    ...
                    @if($spare)
                    value="{{$spare->last_maintenance_date}}"
                    @endif
                />
                <br />
                ...
                <input
                    id="due_maintenance_date"
                    name="due_maintenance_date"
                    type="date"
                    placeholder="Enter Due Maintenance Date"
                    @if($spare)
                    value="{{$spare->due_maintenance_date}}"
                    @endif
                />
                <br />
                ...
                <input
                    ...
                    @if($spare)
                    value="{{$spare->operation_start_date}}"
                    @endif
                />
                <br />
                ...
                <textarea
                    ...
                    required
                >
@if($spare) {{$spare->description}} @endif</textarea
                >
                ...
                <div style="display: flex; justify-content: center">
                    <button id="button" type="submit">
                        @if($spare) Update @else Add @endif
                    </button>
                </div>
                <br /><br />
            </form>
