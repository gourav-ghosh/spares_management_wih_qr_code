...
<div class="add_spare_bg" style="display: flex; justify-content: space-around">
    <div style="width: 500px; max-width: 20%"></div>
    <div style="padding-left: 30px">
        ...
        <div>
            ...
            >
                ...
                <div>
                    <span id="customer_style"
                        >Select One:
                        <span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                ...
                <div id="machine_div" hidden>
                    <div id="machine_div">
                        <span id="customer_style"
                            >Machine<span
                                style="color: #f72c1d; padding-left: 1px"
                                >*</span
                            ></span
                        >
                    </div>
                    <select
                        ...
                        required
                    >
                        <option value="" disabled selected>Select Machine                                           
                        </option>
                ...
                <div id="spare_div" hidden>
                    ...
                    >
                        ...
                        @if($spares) @foreach($spares as $spare)
                ...
                <div>
                    <span id="customer_style"
                        >Defect<span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                ...
                <div id="">
                    ...
                    <div
                        id="imagePreview"
                        class="row g-2"
                        style="justify-content: center; margin: 10px auto"
                    ></div>
                </div>
                <br />
...
<script>
    document.getElementById("machine").addEventListener("click", function () {
        document.getElementById("machine_lable").style.background =
            "linear-gradient(90deg, #1F7FD9 0%, #01EAFE 100%, rgba(0, 0, 0, 1) 100%)";
        document.getElementById("spare_lable").style.background = "#9D9D9D";
        machine_selected();
        // select_function1();
    });
    document.getElementById("spare").addEventListener("click", function () {
        document.getElementById("spare_lable").style.background =
            "linear-gradient(90deg, #1F7FD9 0%, #01EAFE 100%, rgba(0, 0, 0, 1) 100%)";
