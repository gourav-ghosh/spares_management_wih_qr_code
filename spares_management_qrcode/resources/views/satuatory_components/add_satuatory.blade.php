...
<div class="add_tool_bg" style="display: flex; justify-content: space-around">
    ...
    <div style="padding-left: 30px">
        <div
            ...
            "
        >
            <u> Add Statutory Components </u>
        </div>
        <div>
            <form
                action="/add_satuatory"
                method="post"
                enctype="multipart/form-data"
            >
                @csrf @if($satuatory)
                <input type="hidden" name="id" value="{{$satuatory->id}}" />
                @endif
                <div>
                ...
                <div>
                    <span id="customer_style"
                        >Type<span style="color: #f72c1d; padding-left: 1px"
                            >*</span
                        ></span
                    >
                </div>
                <select name="type" id="type1" class="type" required">
                    <option value="" disabled selected> -- Select Type --</option>
                    <option value="pressure_vessel" @if($satuatory && $satuatory->type == 'pressure_vessel') selected @endif>Pressure Vessel</option>
                    <option value="lifting_tools" @if($satuatory && $satuatory->type == 'lifting_tools') selected @endif>Lifting Tools</option>
                </select>

                <!-- Add check box for certification status -->
                <div>
                    <span id="customer_style"
                ...
                <div class="checkbox-wrapper-49">
                    <div class="block">
                        <input
                            ...
                            @if($satuatory
                            &&
                            $satuatory->certification_status) checked @endif>
                ...
                <input
                    ...
                    type="date"
                    placeholder="Enter Last Calibration Date"
                    @if($satuatory)
                    value="{{$satuatory->last_calibration_date}}"
                    @endif
                />
                <br />
                ...
                <input
                    ...
                    @if($satuatory)
                    value="{{$satuatory->calibration_due_date}}"
                    @endif
                />
                <br />
                ...
                <textarea
                    ...
                    style="
                        ...
                        width: 90%;
                    "
                    placeholder="Details of satuatory componenets."
                    required
                >
@if($satuatory) {{$satuatory->details}} @endif</textarea
                >
                ...
                <div id="">
                    <div
                        id="imagePreview"
                        class="row g-2"
                        style="justify-content: center; margin: 0px auto"
                    ></div>
                </div>
                <div style="display: flex; justify-content: center">
                    <button id="button" type="submit">
                        @if($satuatory) Update @else Add @endif
                    </button>
                </div>
                <br /><br />
            </form>
